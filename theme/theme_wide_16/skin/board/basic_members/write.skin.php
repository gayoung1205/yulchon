...
<section id="bo_w" class="container margin-top-40">
    ...
    <div class="bo_w_tit write_div">
        <label for="wr_subject" class="sound_only">기업명<strong>필수</strong></label>
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="30" placeholder="기업명">
            <?php if ($is_member) { ?>
    ...
    <div class="bo_w_tit write_div">
        <label for="wr_1" class="sound_only">대표자명<strong>필수</strong></label>
        <div id="write_div">
            <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="30" placeholder="대표자명">
        </div>
    </div>
	
    <div class="bo_w_tit write_div">
        <label for="wr_2" class="sound_only">회사</label>
        <div id="write_div">
            <input type="text" name="wr_2" value="<?php echo $wr_2 ?>" id="wr_2" class="frm_input full_input" size="50" maxlength="30" placeholder="회사 연락처">
        </div>
    </div>
	
    <div class="bo_w_tit write_div">
        <label for="wr_3" class="sound_only">주소</label>
        <div id="write_div">
            <input type="text" name="wr_3" value="<?php echo $wr_3 ?>" id="wr_3" class="frm_input full_input" size="50" maxlength="255" placeholder="주소">
        </div>
    </div>

    <div class="bo_w_tit write_div">
        <label for="wr_4" class="sound_only">주력업종</label>
        <div id="write_div">
            <input type="text" name="wr_4" value="<?php echo $wr_4 ?>" id="wr_4" class="frm_input full_input" size="50" maxlength="100" placeholder="주력업종">
        </div>
    </div>

    <div class="bo_w_tit write_div">
        <label for="wr_5" class="sound_only">홈페이지</label>
        <div id="write_div">
            <input type="text" name="wr_5" value="<?php echo $wr_5 ?>" id="wr_5" class="frm_input full_input" size="50" maxlength="255" placeholder="홈페이지 URL (예: https://example.com)">
        </div>
    </div>
    ...
    function fwrite_submit(f) {
        ...
        $.ajax({
            ...
            success: function(data, textStatus) { subject = data.subject; content = data.content; }
        });
