...
$colspan = 7; // 기존 5 → wr_4, wr_5 추가로 7
    ...
    <div id="bo_btn_top" class="search_wrap">
		...
		<!-- 게시판 검색 시작 { -->
			...
			<select name="sfl" id="sfl">
				...
				<option value="wr_4"<?php echo get_selected($sfl, 'wr_4'); ?>>주력업종</option>
			</select>
		...
		<table class="table table-bordered" style="min-width:1000px;">
		  ...
		  <tbody>
			...
			<tr <?php if ($list[$i]['is_notice']) echo $not; ?>>
				...
				<td class="text-center"><?php echo $list[$i]['wr_4'] ?></td>
				<td class="text-center">
					<?php if (!empty($list[$i]['wr_5'])) { ?>
					<a href="<?php echo get_text($list[$i]['wr_5']) ?>" target="_blank" rel="noopener">
