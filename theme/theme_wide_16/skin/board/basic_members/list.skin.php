    ...
    <div id="bo_btn_top" class="search_wrap">
		...
		<!-- 게시판 검색 시작 { -->
			...
			<select name="sfl" id="sfl">
				<option value="wr_subject"<?php echo get_selected($sfl, 'wr_subject', true); ?>>기업명</option>
				<option value="wr_1"<?php echo get_selected($sfl, 'wr_1'); ?>>대표자명</option>
				<option value="wr_2"<?php echo get_selected($sfl, 'wr_2'); ?>>회사 연락처</option>
		...
		<table class="table table-bordered">
		  <thead>
			<tr>
				...
				<th class="text-center board_title">기업명</th>
