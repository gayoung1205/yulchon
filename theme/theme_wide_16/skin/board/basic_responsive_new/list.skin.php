		...
		<table class="table table-bordered">
		  <thead>
			<tr>
				...
				<th class="text-center board_title">제목</th>
				<th class="text-center board_name">글쓴이</th>
				<th class="text-center board_hit"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 <i class="fa fa-sort" aria-hidden="true"></i></a></th>
				...
				<th class="text-center board_date"><?php echo subject_sort_link('wr_datetime', $qstr2, 1) ?>날짜  <i class="fa fa-sort" aria-hidden="true"></i></a></th>
			</tr>
		  </thead>
		  <tbody>
			<?php
			...
			<tr <?php if ($list[$i]['is_notice']) echo $not; ?>>
				...
				<td class="text-center board_name"><span class="profile_img"><?php echo get_member_profile_img($list[$i]['mb_id']);?></span> <?php echo $list[$i]['name'] ?></td>
				<td class="text-center board_hit"><?php echo $list[$i]['wr_hit'] ?></td>
				...
				<td class="text-center board_date"><?php echo $list[$i]['datetime2'] ?></td>
			</tr>
			<?php } ?>
