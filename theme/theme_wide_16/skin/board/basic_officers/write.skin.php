...
<section id="bo_w" class="container margin-top-40">
    ...
    <div class="bo_w_tit write_div">
        <label for="wr_subject">회사명 <strong>필수</strong></label>
        <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="frm_input full_input required" size="50" maxlength="100" placeholder="회사명">
    </div>

    <div class="bo_w_tit write_div">
        <label for="wr_1">직위 <strong>필수</strong></label>
        <input type="text" name="wr_1" value="<?php echo $wr_1 ?>" id="wr_1" required class="frm_input full_input required" size="50" maxlength="30" placeholder="직위 (예: 회장, 부회장, 이사)">
    </div>
